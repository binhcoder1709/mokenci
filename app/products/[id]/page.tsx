...
export default function ProductPage({ params }: { params: { id: string } }) {
  ...
  const product = {
    ...
    price: 850000,
    description:
      "Áo sơ mi đen thiết kế hiện đại, chất liệu cotton cao cấp, thoáng mát và thoải mái khi mặc. Phù hợp cho nhiều dịp khác nhau từ công sở đến dạo phố.",
    details: [
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-4 gap-2">
                {product.images.map((image, index) => (
                  <div key={index} className="relative aspect-square overflow-hidden cursor-pointer">
                    <Image
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <RadioGroup defaultValue="Đen" className="flex flex-wrap gap-2">
